...
import 'package:newversion/screens/VentanaInicioSesionLogin.dart';
import 'package:newversion/screens/VentanaRegistroConEmail.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              onPressed: () {
                // Implementa aquí el registro con Apple si es necesario
                ScaffoldMessenger.of(context).showSnackBar(
